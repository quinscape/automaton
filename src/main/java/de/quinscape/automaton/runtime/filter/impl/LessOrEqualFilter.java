...
public final class LessOrEqualFilter
    implements ConfigurableFilter
{
    ...
    public Object evaluate(FilterContext ctx)
    {
        ...
        {
            return valueA.equals(valueB) || ((Timestamp) valueA).before((Timestamp) valueB);
        }
        else if (valueA instanceof Date)
        {
            return valueA.equals(valueB) || ((Date) valueA).before((Date) valueB);
        }
        else
        {
